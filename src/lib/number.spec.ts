...
import { formatNumber, numberToWord, numberToWordKm, toASCII, toKhmer } from "./number"
...
describe("numberToWordKm", () => {
  ...
  it("handles decimals", () => {
    expect(numberToWordKm(1234567.89)).toEqual(
      "មួយលាន ពីរសែន បីម៉ឺន បួនពាន់ ប្រាំរយ ហុកសិបប្រាំពីរ ក្បៀស ប្រាំបី ប្រាំបួន"
    )
  })
